...
public class SendMessages {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            Socket socket_01 = new Socket(args[0], Integer.parseInt(args[2]));
            Socket socket_02 = new Socket(args[1], Integer.parseInt(args[2]));
            //根据输入输出流和服务端连接
            ...
            PrintWriter printWriter_02 = new PrintWriter(outputStream_01);//将输出流包装成打印流

            BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(args[3])));
            String value = "";
            int index = 0;
            while ((value = br.readLine()) != null) {
                if (index == 0) {
                    printWriter_01.print(value);
                    printWriter_01.flush();
                    index = 1;
                } else {
                    printWriter_02.print(value);
