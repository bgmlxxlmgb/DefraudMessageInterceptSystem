...
public class T02 {
    public static void main(String args[]) throws Exception {
        ...
        * */
        ...
        String category_01 = SingleMessageProcessUtil.estimateSingleMessage(SingleMessageProcessUtil.transMessageToInstances(message), message);
        System.out.println("该短信属于：" + category_01);

        String category_02 = SingleMessageProcessUtil.estimateSingleMessage(SingleMessageProcessUtil.transMessageToInstances(message), message);
